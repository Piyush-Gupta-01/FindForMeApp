    ...
    if (savedUser) {
        ...
        navbar.innerHTML = `
            <div class="d-flex align-items-center position-relative">
                <img id="loggedInProfileImage" src="${loggedInUser.profileImage || 'default-profile.png'}" alt="Profile" class="rounded-circle" style="cursor: pointer; width: 40px; height: 40px;">
                <span class="ms-2">${loggedInUser.firstName}</span>
                <div id="miniDashboard" class="mini-dashboard" style="
                    position: absolute;
                    top: 50px;
                    right: 0;
                    background: #fff;
        ...
        profileImage.addEventListener("click", (event) => {
            ...
            miniDashboard.style.display = miniDashboard.style.display === "block" ? "none" : "block";
        });
